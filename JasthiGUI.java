...
class Variable
{
    ...
    /**
     *  Given a variable name, returns the string
     *  representing the argument name as per
   ...
   /**
	 *  Constructor that sets up a variable
	 *  given a comma-separated string outlining
   ...
   /**
    ...
    public String getInvokeSetMethodCode()
    {
        ...
        String invoke_set_method_code = ".set"  + first_character_upper_case +
                                 rest_of_string +
                                 "(" + dummy_value + ");";
...
class Jasthi
{
    ...
    /**
     *  This constructor takes the className and
     *  the Variable[ ] as the inputs
     *
     */
    ...
    /**
     *  This constructor takes "in_file_name" as the input
     *  and populates the instance variables of Jasthi.
     *  The first line in the input file contains the class name
     *  Rest of the lines in the input file contains the details of the instance varialbes as follows.
     *  variable name, variable type, variable qualifier, variable documentation
     *  variable name, variable type, variable qualifier, variable documentation
     *  variable name, variable type, variable qualifier, variable documentation
     */
    Jasthi(String in_file_name)
    {
      ...
      /**
       * Method to generate the Argument String to be used
      ...
      /**
       * Method to generate the variable assignments
      ...
      private String generateMainMethod()
      {
          ...
          String instance_1_string =   className + " " + instance_1 +
                                       " = new " + className + "( );";
      ...
      /**
       * Method to return the String representation of Jasthi.
       * It basically tells the name of the java file
      ...
      /**
       * Main method that takes the file name as the input
       * and generates the code for the class.
       */
            ...
            /* if (args.length == 0)
             {
                  ...
                  System.out.println("Usage:  java Jasthi input_file_name");
                  System.exit(0);
             }*/
...
/**
 * Siva Jasthi (sjathi@msn.com)
 * A GUI-based application
 *
 * Title:        JasthiGUIUI
 * Description:  Compares the contents of two arrays
 * and describes how their contents differ.
 */

public class JasthiGUI   extends JFrame
             implements ActionListener
{
  ...
  /**
   *  Method for saving the generated code.
   *  Users can modify the generated code.
   */
  private void saveTheCode()
  {
	  ...
	  if (outputCodeText.getText().equals(""))
	  {
		   ...
		   JOptionPane.showMessageDialog(new Frame(),
					   warning_string, "JasthiGUI Warning", JOptionPane.WARNING_MESSAGE);
		   return;
      }
      ...
      catch (IOException e)
      {
		  ...
		  JOptionPane.showMessageDialog(new Frame(),
		    	               warning_string, "JasthiGUI Error", JOptionPane.ERROR_MESSAGE);
  	      return;
	  }


	  String message_string = file_name +" is created successfuly. \n " +
	                          "You can try compiling and running  " + file_name;
	  JOptionPane.showMessageDialog(new Frame(),
		    message_string, "JasthiGUI Information", JOptionPane.INFORMATION_MESSAGE);
  }
  ...
  private void generateCode()
  {
	   ...
	   //3. verify that the user has entered values
	    if ( class_name.trim().equals("") ||
	         variable_list_string.trim().equals("") )
	    {
		...
		StringTokenizer new_string =
					 new StringTokenizer(variable_list_string,"\n");
		int i = 0;
		...
		Jasthi jasthi_java_class =
			   new Jasthi(class_name, variable_array);
  ...
  /**
   *  For showing the help on how the students
   *  can generate Java Code for simple java classes
   *  using JasthiGUI program.
   */
  private void showTheHelp()
  {
       ...
       JOptionPane.showMessageDialog(new Frame(),
  	         help_string, "JasthiGUI Help", JOptionPane.INFORMATION_MESSAGE);
